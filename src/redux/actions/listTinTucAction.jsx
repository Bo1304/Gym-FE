...
import {UPDATE_GYM_TINTUC_LIST_PENDING} from "../constants/listTinTucconstans";

export const actionFetchTinTucs =   async (dispatch) => {
    ...
    try {
      const res = await axios({
        // url = domain + endpoint
        url: "http://localhost:3002/api/tintucs",
        method: "GET",
   ...
   export function getItemFromNextPageAfterDeleteTinTuc(dataTable1, pageTable1, dataTable2, setDataTable1, setDataTable2) {
