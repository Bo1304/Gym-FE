...
import {UPDATE_GYM_HOADON_LIST_PENDING} from "../../constants/listHoaDonconstans";

export const actionFetchHoaDons =   async (dispatch) => {
    ...
    try {
      const res = await axios({
        // url = domain + endpoint
        url: "http://localhost:3002/api/hoadon/getHoaDons",
        method: "GET",
